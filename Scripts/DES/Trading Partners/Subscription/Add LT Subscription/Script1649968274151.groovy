...
WebUI.click(findTestObject('Object Repository/KAG Portal/Page_data-exchange/a_Subscription (12)'))
...
WebUI.click(findTestObject('Object Repository/KAG Portal/Page_data-exchange/button_Add (9)'))
